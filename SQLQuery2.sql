...
INSERT INTO tbl_care
	...
	('care_6', 'drain and fill aquarium', 1),
...
INSERT INTO tbl_specialist
	...
	VALUES
	('margaret', 'nguyen', '408-555,0764'),
	('mary', 'fischer', '818-555-5455'),
	('arnold', 'holden', '650-555-4432'),
	('kem', 'byesan', '503-555-6785'),
	('delmonte', 'fyedo', '727-555-8787')
;
...
INSERT INTO tbl_species
	...
	('gray wolf', 1, 102, 1, 5000, 2201, 'care_4')
;
...
SELECT
	...
	FROM tbl_species a1
	INNER JOIN tbl_habitat a2 ON a1.species_habitat = a2.habitat_id
